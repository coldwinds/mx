...
return false;this.restore();tools.ajax_loading_tip('success',this.config.lang.M02,3);},get_data_preview:function(){var doc=document,$insert_btns=doc.querySelectorAll('.ctb-insert-btn');if(!$insert_btns[0])
