...
define(function(require,exports){'use strict';var tools=require('modules/tools'),js_request=require('theme-cache-request');exports.config={process_url:'',tpl_input:'',tpl_preview:'',min_posts:5,max_posts:10,lang:{M01:'Loading, please wait...',M02:'A item has been deleted.',M03:'Getting post data, please wait...',M04:'Previewing, please wait...',E01:'Sorry, server is busy now, can not respond your request, please try again later.',E02:'Sorry, the minimum number of posts is %d.',E03:'Sorry, the maximum number of posts is %d.',E04:'Sorry, the post id must be number, please correct it.'}}
